...
<footer className="mw-100 pa4 pa5-l bg-light-gray">
  <div className="mb4-l flex flex-column flex-row-ns mw9  pt4 pt0-ns center">
    <span className="f7 f6-l black-80">Reach Out</span>
    ...
    <article className="fl w-50 dib-ns w-auto-ns mr4-m mr5-l mb4 pr2 pr0-ns">
      <span className="f7 f6-l db black-80">3440 20th St.</span>
      <span className="f7 f6-l db black-80">San Francisco, CA 94110 </span>
    </article>
  </div>
  <div className="dt dt--fixed w-100" >
    <div className="dn dtc-ns v-mid">
      <p className="f7 black-80 dib pr3 mb3">
