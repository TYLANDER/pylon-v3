...
<footer className="pa4 pa5-l black-70 bt b--black-10">
  <div className="mb4-l cf">
    <h1 className="fl w-100 pv0 f6 fw6 ttu tracked mb4">Studio Location</h1>
  ...
  <section className="cf mb5">
    <div className="mb4 mb0-ns fl w-100 w-50-l" >
      ...
      <input placeholder="Email Address" className="mw-100 w-100 w5-ns f5 input-reset ba b--black-20 pv3 ph4 border-box"></input>
      <input type="submit" className="input-reset w-100 w-auto-ns bg-black-80 white f5 pv2 pv3-ns ph4 ba b--black-80 bg-hover-mid-gray"></input>
    </div>
  </section>
  <div className="dt dt--fixed w-100" >
    ...
    <div className="db dtc-ns black-70 tc tr-ns v-mid">
      ...
      <a href="https://twitter.com/tylerschmidt" className="link dim dib mr3 black-70">
      ...
      <a href="https://medium.com/tylerschmidt" className="link dim dib mr3 black-70" title="Tyler's Medium Page">
