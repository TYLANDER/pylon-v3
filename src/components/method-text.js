...
export default () => (
    <section class="flex flex-column flex-row-ns mw9 center">
      ...
      <iframe width="560" height="315" src="https://www.youtube.com/embed/UtOzC-zoA3g" frameborder="0" allowfullscreen></iframe>
        <li class="pa3 pa4-ns">
          <b class="db f6 ttu tracked mb1 mt3">Define the Problem</b>
