...
<div className="w-100">
  ...
  <header className='mw8-m mw9-l center ph3 ph5-l pt6'>
    <div className='cf' >
      <div className="fl dib w-100 w-50-l mt0-m mv5-ns mb5 fw4 f4 f3-ns v-mid-ns pr0 pr4-m">
        <h1 className="dib  f-5 fw6 bt bb bw2 mv0 mv3-m lh-title">Utility for End Users</h1>
          <h4 className="f4 f4-ns lh-copy fw4 mt0 mv3 near-black measure-narrow">
